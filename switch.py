        ...
        try:
            ...
            if id < 0 or id >= swt_dev.maxswitch:
                resp.text = MethodResponse(req,
                                InvalidValueException(f'Id {id} outside the range [0-{swt_dev.maxswitch}].')).json
                return
        except:
            resp.text = MethodResponse(req,
...
class getswitchdescription:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = swt_dev.get_switchdescription(id)
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class minswitchvalue:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = swt_dev.get_minswitchvalue(id)
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class maxswitchvalue:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = swt_dev.get_maxswitchvalue(id)
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
