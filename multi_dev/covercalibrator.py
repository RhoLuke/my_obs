...
class CovercalibratorMetadata:
    ...
    DeviceID = '2B2ADF56-B2BC-4618-9EA2-F260C3550207' # https://guidgenerator.com/online-guid-generator.aspx
    Info = 'Alpaca Sample Device\nImplements ICovercalibrator\nASCOM Initiative'
    MaxDeviceNumber = maxdev
    InterfaceVersion = 1       # ICovercalibratorVxxx

# At app init not import :-)
def start_fb_device(logger: logger):
    logger = logger
    global fb_dev
    fb_dev = flatbox_device.FlatBox(logger)
...
class brightness:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        if not fb_dev.connected:
            resp.text = PropertyResponse(None, req,
                            NotConnectedException()).json
            return
        try:
            # ----------------------
            val = fb_dev.current_brightness
            # ----------------------
